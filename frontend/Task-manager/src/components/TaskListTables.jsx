      ...
      <table className='min-w-full'>
        <thead>
          <tr className='text-left'>
            ...
            <th className='py-3 px-4 text-gray-800 font-medium text-[15px] hidden md:table-cell'>CreatedOn</th>
          </tr>
        </thead>
        <tbody>
          {tableData.length === 0 ? (
            ...
            tableData.map((task) => {
              return (
                <tr key={task._id} className='border-t border-gray-200'>
                  <td className='py-3 px-4 text-gray-700 text-[15px] line-clamp-1 overflow-hidden'>{task.title}</td>
